...
DATA_PATHS = {
    "CQ": {
        "target": "CQ",
        "dt_dir": f"{BASE_DIR}/COVID-CQ/in-target/CQ",
        "img_root": f"{BASE_DIR}/COVID-CQ/images",
    },
    "DT": {
        "target": "DT",
        "dt_dir": f"{BASE_DIR}/2020-US-Presidential-Election/in-target/DT",
        "img_root": f"{BASE_DIR}/2020-US-Presidential-Election/images",
    },
    "JB": {
        "target": "JB",
        "dt_dir": f"{BASE_DIR}/2020-US-Presidential-Election/in-target/JB",
        "img_root": f"{BASE_DIR}/2020-US-Presidential-Election/images",
    },
    "TOC": {
        "target": "TOC",
        "dt_dir": f"{BASE_DIR}/TW-Question/in-target/TOC",
        "img_root": f"{BASE_DIR}/TW-Question/images",
    },
    "MOC": {
        "target": "MOC",
        "dt_dir": f"{BASE_DIR}/TW-Question/in-target/MOC",
        "img_root": f"{BASE_DIR}/TW-Question/images",
    },
    "AET_HUM": {
        "target": "AET_HUM",
        "dt_dir": f"{BASE_DIR}/WT-WT/in-target/AET_HUM",
        "img_root": f"{BASE_DIR}/WT-WT/images",
    },
    "ANTM_CI": {
        "target": "ANTM_CI",
        "dt_dir": f"{BASE_DIR}/WT-WT/in-target/ANTM_CI",
        "img_root": f"{BASE_DIR}/WT-WT/images",
    },
    "CI_ESRX": {
        "target": "CI_ESRX",
        "dt_dir": f"{BASE_DIR}/WT-WT/in-target/CI_ESRX",
        "img_root": f"{BASE_DIR}/WT-WT/images",
    },
    "CSV_AET": {
        "target": "CSV_AET",
        "dt_dir": f"{BASE_DIR}/WT-WT/in-target/CSV_AET",
        "img_root": f"{BASE_DIR}/WT-WT/images",
    },
    "FOXA_DIS": {
        "target": "FOXA_DIS",
        "dt_dir": f"{BASE_DIR}/WT-WT/in-target/FOXA_DIS",
        "img_root": f"{BASE_DIR}/WT-WT/images",
    },
    "UKR": {
        "target": "UKR",
        "dt_dir": f"{BASE_DIR}/RU-Conflict/in-target/UKR",
        "img_root": f"{BASE_DIR}/RU-Conflict/images",
    },
    "RUS": {
        "target": "RUS",
        "dt_dir": f"{BASE_DIR}/RU-Conflict/in-target/RUS",
        "img_root": f"{BASE_DIR}/RU-Conflict/images",
    },
}
